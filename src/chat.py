...
def apply_chat_template(template, messages, system_message=None, tokenizer:PreTrainedTokenizer=None, add_generation_prompt=False, return_labels=False, **tokenization_kwargs):
    ...
    # do not use chat template when pretraining    
    if template == "no":
        ...
        # * pretrain
        # encoded = tokenizer(conversation, max_length=8192, truncation=True)
...
if __name__ == "__main__":
    from fastchat.convers2ation import get_conv_template
