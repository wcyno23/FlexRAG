...
from main_embedding.embedder import get_sentence_begin_indices, get_sentence_priority_list, merge, SentenceEmbedder
...
def process_flexrag_dynamic_instruction_tuning(
    ...
    if eval_mode:
        ...
        # * Use embedding model extracting importance token from encoder_input_ids
...
def main():
    ...
    for dataset_name in dataset_dict.keys():
        ...
        sentences_ids_lists = []
        for inputs in tqdm(dataloader, desc=f"prepare open domain qa sentence embedding: {dataset_name}"):
